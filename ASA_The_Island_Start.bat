...
set CommandLine=TheIsland_WP?listen?Port=7777?QueryPort=27015?RCONPort=27020?RCONEnabled=True?SessionName="Island PVE"?MaxPlayers=70?ServerAdminPassword=YourPasswordHere -NoBattlEye -automanagedmods -Mods=928708,930404,928677,928621,929420,930128,931372,931877,929543,929038,936887,928818,929713 -crossplay -webalarm -servergamelog -game -server -log 
